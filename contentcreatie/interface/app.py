...
if user:
    ...
    pg = st.navigation([
        st.Page(
            "pages/0_Project_Selectie.py", 
            title="Project Selectie", 
            icon=":material/folder_open:", 
            default=True
        ),
        st.Page(
            "pages/1_Zoeken_en_Selecteren.py", 
            title="Zoeken & Selecteren", 
            icon=":material/search:"    
        ),
        st.Page(
            "pages/2_Consolideren.py", 
            title="Consolideren", 
            icon=":material/psychology:"   
        ),
        st.Page(
            "pages/3_Herschrijven.py", 
            title="Herschrijven", 
    ...
    st.warning("U heeft geen toegang tot deze applicatie.", icon=":material/lock:")